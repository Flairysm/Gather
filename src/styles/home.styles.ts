...
export const home = StyleSheet.create({
  ...
  // ── Inline Live Card (inside vendor store scroll) ──
  liveInlineCard: {
  ...
  liveInlineBadge: {
    ...
    alignItems: "center",
    gap: 4,
    backgroundColor: "rgba(234,61,94,0.92)",
    borderRadius: 4,
    paddingHorizontal: 7,
    paddingVertical: 2,
  },
  ...
  liveInlineOverlayLive: {
    color: "#fff",
    fontSize: 12,
    fontWeight: "900",
    letterSpacing: 1.2,
  },
  liveInlineOverlayJoin: {
    color: "#fff",
    fontSize: 11,
    fontWeight: "800",
    letterSpacing: 0.8,
