...
- **admin-web:** Next 16, Tailwind v4, `@supabase/ssr`—see `AGENTS.md` in this folder for commands and scope.
- **Mobile** lives at repo root `src/` (Expo); **do not mix** RN and Next conventions.
